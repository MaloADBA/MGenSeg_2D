...
def get_r50_b16_config():
    ...
    config.classifier = 'seg'
    config.pretrained_path = '/home/travail/maalef/ssl-seg-eugene/model/configs/3d_mbrats/R50+ViT-B_16.npz'
    config.decoder_channels = (256, 128, 64, 16)
...
def build_model():
    ...
    net = VisionTransformer(config, img_size=256, num_classes=1)
